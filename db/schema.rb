...
ActiveRecord::Schema.define(version: 20170803151033) do

  create_table "aws_profiles", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "buckets", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "updated_at", default: -> { "CURRENT_TIMESTAMP" }
    t.datetime "deleted_at"
    t.index ["aws_profile_id"], name: "index_buckets_on_aws_profile_id"
  ...
  add_foreign_key "buckets", "aws_profiles"
